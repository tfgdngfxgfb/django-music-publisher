# Klango – import readiness

Status: **UNKNOWN / SAMPLE_REQUIRED** for konkret eksportformat.

Kilden kan være feil eller svakere enn P7. Raw bevares først. Ved mismatch mot oppgitt canonical verdi returneres ASSERTION_ONLY/manual review. Beskyttede data overskrives aldri.
