# LU-MI – import readiness

Status: **UNKNOWN / SAMPLE_REQUIRED** for konkret eksportformat.

Sparse historiske data støttes. Manglende ISRC, full dato, artistidentitet, rights og digital fil skal forbli manglende. År konverteres ikke til en konstruert full dato.
