...
urlpatterns = [
    ...
    path(
        "musikkarkiv/les-inn/",
        views.flac_ingest_start,
        name="flac_ingest_start",
    ),
    path(
    ...
    path(
        "utgivelser/<uuid:pk>/spor/",
        views.release_tracks,
        name="release_tracks",
    ),
    path("innspillinger/<uuid:pk>/", views.recording_detail, name="recording"),
    path(
        "innspillinger/<uuid:pk>/rediger/",
        views.recording_edit,
        name="recording_edit",
    ),
    path(
    ...
    path(
        "innspillinger/<uuid:pk>/radio/", views.radio_edit, name="radio_edit"
    ),
    path(
    ...
    path(
        "kilder/<uuid:pk>/handling/",
        views.assertion_action,
        name="assertion_action",
    ),
    path(
    ...
    path(
        "filer/<uuid:pk>/plassering/",
        views.file_location_add,
        name="file_location_add",
    ),
]
