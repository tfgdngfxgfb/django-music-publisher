...
| `TXXX:Rotasjon - Ikke Rotasjonsverdig` fantes bare i rådata | Rotasjon var ikke mappet til den normaliserte radiomodellen | Egen kontrollert rotasjonsvurdering lagres og vises som lokal vurdering, adskilt fra filstatus og Energy. Adapterversjon 3 etterbehandler registrerte filer | Adapter-, ingest- og GUI-test |
